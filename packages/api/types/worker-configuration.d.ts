/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings ./types/worker-configuration.d.ts` (hash: ecf1da34583934a8904558ba50d8d701)
